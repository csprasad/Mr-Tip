...
class CalculatorScreen {
    ...
    var totalTipValueLabel: XCUIElement {
        app.staticTexts[ScreenIdentifier.ResultView.totalTipValueLable.rawValue]
    }
    ...
    var splitValueLabel: XCUIElement {
        app.staticTexts[ScreenIdentifier.SplitInputView.quantityValueLable.rawValue]
    }
    ...
    func selectDecementButton(numberOfTaps: Int) {
